...
<body>
    <div id="main-container">
        ...
        <div class="form-container">
            ...
            <h4>REGISTRAR NUEVO FUNCIONARIO</h4>
            <form>
                <!-- Campos del formulario para funcionarios -->
                ...
                <label for="pname">NOMBRE COMPLETO</label>
                    ...
                    <label for="profesion">ACTIVIDAD LABORAL</label>
                    <input type="text" id="name" name="profesion" required> 
                     @error('semestre')
                    <div class="alert alert-danger">{{$message}}</div>
                     @enderror 
